...
# This file is generated by maven
...
scp -r plasma2simulink.mlappinstall $USER@$HOST:/home/groups/plasma-lab/htdocs/plasma_lab_bundle/plasma2simulink/PLASMA2Simulink_${project.version}.mlappinstall
