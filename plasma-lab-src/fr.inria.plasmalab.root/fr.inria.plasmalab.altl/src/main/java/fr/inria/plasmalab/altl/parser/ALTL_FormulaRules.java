 ...
 */
// $ANTLR 3.4 FormulaRules.g 2017-02-23 16:23:36
...
public class ALTL_FormulaRules extends Parser {
    ...
    // delegators
    public ALTLParser gALTL;
    public ALTLParser gParent;


    public ALTL_FormulaRules(TokenStream input, ALTLParser gALTL) {
        this(input, new RecognizerSharedState(), gALTL);
    }
    public ALTL_FormulaRules(TokenStream input, RecognizerSharedState state, ALTLParser gALTL) {
        super(input, state);
        this.gALTL = gALTL;
        gParent = gALTL;
    }
        ...
        try {
            ...
            switch (alt27) {
                ...
                case 3 :
                    ...
                    x=y=bvalue8; type = VariableType.BOOL;
    ...
    public final double floating() throws RecognitionException {
        ...
        Token FLOATING11=null;

        try {
            // FormulaRules.g:223:3: ( FLOATING )
            // FormulaRules.g:223:3: FLOATING
            {
            FLOATING11=(Token)match(input,FLOATING,FOLLOW_FLOATING_in_floating3033); 

             try{val = Double.parseDouble((FLOATING11!=null?FLOATING11.getText():null));}catch(NumberFormatException e){val =0;} 
    ...
    public final int integer() throws RecognitionException {
        ...
        try {
            ...
            // FormulaRules.g:227:3: DIGITS
            {
            DIGITS12=(Token)match(input,DIGITS,FOLLOW_DIGITS_in_integer3050); 

             try { val = Integer.parseInt((DIGITS12!=null?DIGITS12.getText():null)); }
    ...
    public static final BitSet FOLLOW_implication_in_expr42 = new BitSet(new long[]{0x0018000000000002L});
    public static final BitSet FOLLOW_UNTIL_in_expr133 = new BitSet(new long[]{0x0000000080000000L});
    public static final BitSet FOLLOW_WEAK_in_expr178 = new BitSet(new long[]{0x0000000080000000L});
    public static final BitSet FOLLOW_bound_in_expr231 = new BitSet(new long[]{0x0004406509724000L});
    public static final BitSet FOLLOW_expr_in_expr235 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_FATALLY_in_expr375 = new BitSet(new long[]{0x0000000080000000L});
    public static final BitSet FOLLOW_GLOBALLY_in_expr418 = new BitSet(new long[]{0x0000000080000000L});
    public static final BitSet FOLLOW_bound_in_expr473 = new BitSet(new long[]{0x0004406509724000L});
    public static final BitSet FOLLOW_NEXT_in_expr511 = new BitSet(new long[]{0x0004406589724000L});
    public static final BitSet FOLLOW_bound_in_expr567 = new BitSet(new long[]{0x0004406509724000L});
    public static final BitSet FOLLOW_expr_in_expr627 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_REWARD_in_expr645 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_LC_in_expr647 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_DQ_in_expr649 = new BitSet(new long[]{0x0000000008000000L});
    public static final BitSet FOLLOW_IDENT_in_expr651 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_DQ_in_expr653 = new BitSet(new long[]{0x0000200000000000L});
    public static final BitSet FOLLOW_RC_in_expr655 = new BitSet(new long[]{0x0004406509724000L});
    public static final BitSet FOLLOW_expr_in_expr659 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LE_in_bound707 = new BitSet(new long[]{0x0002000100404000L});
    public static final BitSet FOLLOW_SH_in_bound710 = new BitSet(new long[]{0x0000000100404000L});
    public static final BitSet FOLLOW_number_in_bound762 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LP_in_bound803 = new BitSet(new long[]{0x0004000508524000L});
    public static final BitSet FOLLOW_numExp_in_bound807 = new BitSet(new long[]{0x0000800000000000L});
    ...
    public static final BitSet FOLLOW_LP_in_bound939 = new BitSet(new long[]{0x0004000508524000L});
    public static final BitSet FOLLOW_numExp_in_bound943 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_RP_in_bound945 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_disjunction_in_implication995 = new BitSet(new long[]{0x0000000010000002L});
    public static final BitSet FOLLOW_IMP_in_implication1042 = new BitSet(new long[]{0x0004004508524000L});
    public static final BitSet FOLLOW_disjunction_in_implication1046 = new BitSet(new long[]{0x0000000010000002L});
    public static final BitSet FOLLOW_conjunction_in_disjunction1108 = new BitSet(new long[]{0x0000020000000002L});
    public static final BitSet FOLLOW_OR_in_disjunction1156 = new BitSet(new long[]{0x0004004508524000L});
    ...
    public static final BitSet FOLLOW_AND_in_conjunction1273 = new BitSet(new long[]{0x0004004508524000L});
    public static final BitSet FOLLOW_equality_in_conjunction1277 = new BitSet(new long[]{0x0000000000000042L});
    public static final BitSet FOLLOW_NOT_in_equality1352 = new BitSet(new long[]{0x0004000508524000L});
    public static final BitSet FOLLOW_relExp_in_equality1402 = new BitSet(new long[]{0x0000001000080002L});
    public static final BitSet FOLLOW_eop_in_equality1449 = new BitSet(new long[]{0x0004000508524000L});
    ...
    public static final BitSet FOLLOW_numExp_in_relExp1618 = new BitSet(new long[]{0x0000000282800002L});
    public static final BitSet FOLLOW_rop_in_relExp1667 = new BitSet(new long[]{0x0004000508524000L});
    ...
    public static final BitSet FOLLOW_term_in_numExp1915 = new BitSet(new long[]{0x0000000400000012L});
    public static final BitSet FOLLOW_nop_in_numExp1966 = new BitSet(new long[]{0x0004000508524000L});
    public static final BitSet FOLLOW_term_in_numExp1970 = new BitSet(new long[]{0x0000000400000012L});
    ...
    public static final BitSet FOLLOW_factor_in_term2126 = new BitSet(new long[]{0x0000000800008002L});
    public static final BitSet FOLLOW_top_in_term2173 = new BitSet(new long[]{0x0004000508524000L});
    public static final BitSet FOLLOW_factor_in_term2177 = new BitSet(new long[]{0x0000000800008002L});
    ...
    public static final BitSet FOLLOW_DECLARE_in_declareVars2606 = new BitSet(new long[]{0x0000000008000000L});
    public static final BitSet FOLLOW_variable_in_declareVars2610 = new BitSet(new long[]{0x0001000000000002L});
    public static final BitSet FOLLOW_SEMI_in_declareVars2625 = new BitSet(new long[]{0x0000000008000000L});
    public static final BitSet FOLLOW_variable_in_declareVars2629 = new BitSet(new long[]{0x0001000000000002L});
    public static final BitSet FOLLOW_OPTIMIZE_in_optimizeVars2643 = new BitSet(new long[]{0x0000000008000000L});
    public static final BitSet FOLLOW_variable_in_optimizeVars2647 = new BitSet(new long[]{0x0001000000000002L});
    public static final BitSet FOLLOW_SEMI_in_optimizeVars2663 = new BitSet(new long[]{0x0000000008000000L});
    public static final BitSet FOLLOW_variable_in_optimizeVars2667 = new BitSet(new long[]{0x0001000000000002L});
    public static final BitSet FOLLOW_OVERRIDE_in_overrideIds2679 = new BitSet(new long[]{0x0000000008000000L});
    public static final BitSet FOLLOW_IDENT_in_overrideIds2683 = new BitSet(new long[]{0x0001000000000002L});
    public static final BitSet FOLLOW_SEMI_in_overrideIds2698 = new BitSet(new long[]{0x0000000008000000L});
    public static final BitSet FOLLOW_IDENT_in_overrideIds2702 = new BitSet(new long[]{0x0001000000000002L});
    public static final BitSet FOLLOW_IDENT_in_variable2767 = new BitSet(new long[]{0x0000000000000200L});
    public static final BitSet FOLLOW_COLEQ_in_variable2769 = new BitSet(new long[]{0x0004000020504000L});
    ...
    public static final BitSet FOLLOW_LB_in_range2830 = new BitSet(new long[]{0x0004000000504000L});
    public static final BitSet FOLLOW_number_in_range2839 = new BitSet(new long[]{0x0001000000000000L});
    public static final BitSet FOLLOW_SEMI_in_range2841 = new BitSet(new long[]{0x0000000000404000L});
    public static final BitSet FOLLOW_number_in_range2845 = new BitSet(new long[]{0x0001100000000000L});
    public static final BitSet FOLLOW_SEMI_in_range2863 = new BitSet(new long[]{0x0000000000404000L});
    public static final BitSet FOLLOW_number_in_range2867 = new BitSet(new long[]{0x0000100000000000L});
    public static final BitSet FOLLOW_bvalue_in_range2892 = new BitSet(new long[]{0x0001100000000000L});
    public static final BitSet FOLLOW_SEMI_in_range2909 = new BitSet(new long[]{0x0004000000100000L});
    public static final BitSet FOLLOW_bvalue_in_range2913 = new BitSet(new long[]{0x0000100000000000L});
