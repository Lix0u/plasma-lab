 ...
 */
// $ANTLR 3.4 FormulaTokens.g 2017-02-23 16:23:36
...
public class ALTL_FormulaTokens extends Lexer {
    ...
    // delegates
    // delegators
    public ALTLLexer gALTL;
    public ALTLLexer gParent;
    public Lexer[] getDelegates() {
        return new Lexer[] {};
    }

    public ALTL_FormulaTokens() {} 
    public ALTL_FormulaTokens(CharStream input, ALTLLexer gALTL) {
        this(input, new RecognizerSharedState(), gALTL);
    }
    public ALTL_FormulaTokens(CharStream input, RecognizerSharedState state, ALTLLexer gALTL) {
        super(input,state);
        this.gALTL = gALTL;
        gParent = gALTL;
    }
