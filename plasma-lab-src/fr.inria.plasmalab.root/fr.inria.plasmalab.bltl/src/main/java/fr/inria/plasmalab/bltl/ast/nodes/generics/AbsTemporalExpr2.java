...
public abstract class AbsTemporalExpr2 extends AbsExpr2 {

	public AbsTemporalExpr2(Expr left, BinOp op, Expr right) {
		super(left, op, right);
		
		if (!op.isTemporal())
			throw new IllegalArgumentException(
					"A Temporal Expression can not be instancied for " + op);
	}
}
