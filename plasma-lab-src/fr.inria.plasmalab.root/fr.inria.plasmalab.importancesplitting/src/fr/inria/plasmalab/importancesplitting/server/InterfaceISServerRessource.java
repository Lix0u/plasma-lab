...
/** An interface only implemented by ImportanceSplittingServerResource */
public interface InterfaceISServerRessource extends InterfaceServerResource {
		
	/**
	 * Results operation where a node sends its newly computed results.
	 * 
	 * @param result an ImportanceSplittingResult
	 */
