...
public class NestedFactory extends AbstractRequirementFactory {
	private static final String name = "Nested BLTL", description = "Bounded-Linear Temporal Logic with nested Probabilities";
	private static final String id = "nested";
