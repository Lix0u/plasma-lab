...
public class Nested_SMCResult implements SMCResult {
	...
	public Nested_SMCResult(boolean satisfied, Map<InterfaceIdentifier, Double> initState, InterfaceIdentifier[] optimVars,
	...
	public Object getValueOf(String header) throws PlasmaExperimentException {
		...
		throw new PlasmaExperimentException("header " + header + " not found in Nested_SMCResult.");
	}
	...
	public Object getValueOf(InterfaceIdentifier id) throws PlasmaExperimentException {
		...
		if (o != null)
			...
			throw new PlasmaExperimentException("header ID " + id.getName() + " not found in Nested_SMCResult.");
	}
