...
class Token {
	...
	public int step = -1;	// necessary initialisation
	public int index = -1;
	public double value = Double.NaN;
	public String toString()
	{
		return "line " + line + ", col " + col + ":\t" + kind + "\t" + val;
	}
...
class Buffer {
	...
	public Buffer(byte [] b)
	{
		buf = b;
		bufStart = bufPos = 0;
		fileLen = bufLen = b.length;
	}

	public void reInit(byte [] b)
	{
		buf = b;
		bufStart = bufPos = 0;
		fileLen = bufLen = b.length;
...
//-----------------------------------------------------------------------------------
/**
 * Scanner frame file for PLASMA-lab
...
public class Scanner {
	...
	static {
		...
		literals.put("U", new Integer(4));
		literals.put("W", new Integer(5));
		literals.put("F", new Integer(6));
		literals.put("G", new Integer(7));
		literals.put("X", new Integer(8));
		literals.put("Pr", new Integer(9));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 3:
					...
					if (ch >= '0' && ch <= '9') {AddCh(); state = 3; break;}
					else if (ch == 'E' || ch == 'e') {AddCh(); state = 4; break;}
