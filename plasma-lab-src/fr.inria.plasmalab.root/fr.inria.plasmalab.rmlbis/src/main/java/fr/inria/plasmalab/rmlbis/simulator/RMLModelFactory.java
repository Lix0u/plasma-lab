...
public class RMLModelFactory extends AbstractModelFactory {
	private static final String name = "RML", description = "A PlasmaLab implementation for the Reactive Module Language.";
	private static final String id = "rml";

	@Override
	public AbstractModel createAbstractModel(String name) {
		return new RMLModel(name,"",id);
	}

	@Override
	public AbstractModel createAbstractModel(String name, File file) throws PlasmaDataException {
		return new RMLModel(name,file,id);
	}

	@Override
	public AbstractModel createAbstractModel(String name, String content) {
		return new RMLModel(name,content,id);
	}
