...
public class RangedDouble extends RangedNumber<Number> {	
	
	public RangedDouble(double lower, double upper, double step) {
	...
	public RangedDouble clone() {
		RangedDouble copy = new RangedDouble(min, max, inc);
		copy.value = value;
		return copy;
	}
