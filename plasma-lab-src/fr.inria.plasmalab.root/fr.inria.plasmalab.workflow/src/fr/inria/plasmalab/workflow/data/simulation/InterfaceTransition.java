 ...
 * A Transition.
 * <p>
 * A Transition is made of a guard, an update and an id/name/channel.
 * @author kevin.corre@inria.fr
 *
 */
public interface InterfaceTransition {
	/**
	 * This method returns the id/name/channel of the transition.
	 * @return the id/name/channel of the transition.
	 */
	public String getName();

	/**
	 * This method returns the update vector of the transition.
	 * @return the update vector of the transition.
	 */
