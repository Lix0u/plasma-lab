...
/** Throw this to stop an experiment.
 * 
 */
public class PlasmaStopOrder extends PlasmaExperimentException {
	private static final long serialVersionUID = 8027535367504292857L;
	private static final String MSG = "Stop order received.";

	public PlasmaStopOrder() {
		super(MSG);
	}
}
