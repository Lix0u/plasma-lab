	ctmc
 	...
 	module walker
		...
		w1 : [0 .. 7] init 1;	// w1=0 is sinkstat for deadlocks
		...
		[step] w1=2 & stator4=0	-> 8.999999999999999E-5 : (w1'=4) & (stator4'=1);
 
		[step] w1=3 & stator1=0	-> 1.7999999999999998E-4 : (w1'=1) & (stator1'=1);
		[step] w1=3 & stator2=0	-> 0.009 : (w1'=2) & (stator2'=1);
		[step] w1=3 & stator4=0	-> 1.7999999999999998E-4 : (w1'=4) & (stator4'=1);
		[step] w1=3 & stator5=0	-> 8.999999999999999E-5 : (w1'=5) & (stator5'=1);
 
		[step] w1=4 & stator2=0	-> 8.999999999999999E-5 : (w1'=2) & (stator2'=1);
		[step] w1=4 & stator3=0	-> 1.7999999999999998E-4 : (w1'=3) & (stator3'=1);
		...
		[step] w1=5 & stator3=0	-> 8.999999999999999E-5 : (w1'=3) & (stator3'=1);
...
| ( w1=2 & stator1=1 & stator3=1 & stator4=1)
| ( w1=3 & stator1=1 & stator2=1 & stator4=1 & stator5=1)
| ( w1=4 & stator2=1 & stator3=1 & stator5=1 & stator6=1 & stator7=1)
| ( w1=5 & stator3=1 & stator4=1 & stator6=1 & stator7=1)
| ( w1=6 & stator4=1 & stator5=1 & stator7=1)
;
