	ctmc
 	...
 	module walker
		...
		[step] w1=5 & stator7=0	-> 8.999999999999999E-6 : (w1'=7) & (stator7'=1);
		...
		[step] w1=6 & stator7=0	-> 1.7999999999999997E-5 : (w1'=7) & (stator7'=1);
		[]	w1 = 1	->	.000000001	: 	(w1'=1);
		[]	w1 = 2	->	.000000001	: 	(w1'=2);
		[]	w1 = 3	->	.000000001	: 	(w1'=3);
		[]	w1 = 4	->	.000000001	: 	(w1'=4);
...
| ( w1=4 & stator1=1 & stator2=1 & stator3=1 & stator5=1 & stator6=1)
| ( w1=5 & stator2=1 & stator3=1 & stator4=1 & stator6=1 & stator7=1)
| ( w1=6 & stator3=1 & stator4=1 & stator5=1 & stator7=1)
;
