	ctmc
 	...
 	module walker
		...
		blockade18		: [0 .. 1] init 0;
		blockade19		: [0 .. 1] init 0;
		...
		[block6]  blockade6=0 	->	1000000.0 * failureRate  : (blockade6'=1) & (stator6'=0)	+	 1000000.0 * (1.0 - failureRate ) : (blockade6'=1);
		[block18]  blockade18=0 	->	1000000.0 * failureRate  : (blockade18'=1) & (stator18'=0)	+	 1000000.0 * (1.0 - failureRate ) : (blockade18'=1);
		[block19]  blockade19=0 	->	1000000.0 * failureRate  : (blockade19'=1) & (stator19'=0)	+	 1000000.0 * (1.0 - failureRate ) : (blockade19'=1);
	...
	rewards "blocked" // time spend in blocked anchorages
		...
		w1 =5 | w1 =6 | w1 =18 | w1 =19 | w1 =26 | w1 =27	:	1;
