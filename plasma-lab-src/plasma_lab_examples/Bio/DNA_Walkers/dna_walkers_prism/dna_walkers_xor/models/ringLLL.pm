	ctmc
 	...
 	module walker
		...
		[block17]  blockade17=0 	->	1000000.0 * failureRate  : (blockade17'=1) & (stator17'=0)	+	 1000000.0 * (1.0 - failureRate ) : (blockade17'=1);
	...
	rewards "blocked" // time spend in blocked anchorages
		...
		w1 =2 | w1 =3 | w1 =4 | w1 =5 | w1 =17 | w1 =18	:	1;
