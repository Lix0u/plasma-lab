	ctmc
 	...
 	module walker
		...
		blockade12		: [0 .. 1] init 0;
		blockade13		: [0 .. 1] init 0;
		blockade10		: [0 .. 1] init 0;
		blockade11		: [0 .. 1] init 0;
		blockade20		: [0 .. 1] init 0;
		blockade21		: [0 .. 1] init 0;
 
		[block12]  blockade12=0 	->	1000000.0 * failureRate  : (blockade12'=1) & (stator12'=0)	+	 1000000.0 * (1.0 - failureRate ) : (blockade12'=1);
		...
		[block20]  blockade20=0 	->	1000000.0 * failureRate  : (blockade20'=1) & (stator20'=0)	+	 1000000.0 * (1.0 - failureRate ) : (blockade20'=1);
	...
	rewards "blocked" // time spend in blocked anchorages
		...
		w1 =12 | w1 =13 | w1 =10 | w1 =11 | w1 =20 | w1 =21	:	1;
